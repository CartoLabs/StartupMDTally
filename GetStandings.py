...
playlistArray = (("PLBN03TRv8YYdSElLZwRlxWXseYyAiHNOO","Ubalt 2013"),\
					("PLBN03TRv8YYd_gFUeOLYg4d0kPBi1EGhE","Gov Fest 2013"),\
					("PLBN03TRv8YYdxGqSqa8L-jPrQmRiNrshp","Innovation Celebration 2013"),\
					("PLBN03TRv8YYdzCiK9N5W3W0hY1_eZDJH2","TEDCO 2013"),\
					("PLBN03TRv8YYc9ewUF0i6YpDRg7VJl-sq_","TCS PRS 2013"),\
					("PLBN03TRv8YYfZauU7DiUAYOvKpAHFW-Td","LSA 2013"),\
					("PLBN03TRv8YYdC2nWciVWL5tCLm1QQuEDb","Havre de Grace 2013"),\
					("PLBN03TRv8YYdmR7Vxe5biaLmRX6tXuMB2","Frederick 2013"),\
					("PLBN03TRv8YYdbJz_h5VYkJDTZg6T9fKPw","Bethesda 2013"),\
					("PLBN03TRv8YYc5_SxjHTydYOqJmtO6U6ob","Garret County 2013"),\
					("PLBN03TRv8YYfmD1OygCzflT8gU1m59bVE","Founder Corps 2013"),\
					("PLBN03TRv8YYdIWWsaxn4PEqNuNJZHqbrB","CoFounders Lab 2013"),\
					("PLBN03TRv8YYc-BB02cv1cShpfVJQuXFd-","Hagerstown 2013"),\
					("PLBN03TRv8YYfomGTMETwHYDkbbhKFeLt1","Betamore 2013"),\
					("PLBN03TRv8YYf-Ix-vl9CeZZHrS2aAX31H","MCE 2013"),\
					("PLBN03TRv8YYf7Ei7PU6r-YnpAQlDNBfbe","Annapolis 2013"),\
					("PLBN03TRv8YYdmQwG9cdcBsVXXo2AwpDC7","Howard Community College 2013"),\
					("PLBN03TRv8YYcxIEBqDLFZZISjr3G08end","Washington College 2013"),\
					("PLBN03TRv8YYdDqZIUTCxJVu27Zgh8cqKB","Salisbury 2013"),\
					("PLBN03TRv8YYeMPddEmrFE-zxWcdM2GAdi","Easton 2013"),\
					("PLBN03TRv8YYfbbzRAARYUu_awnvkK8FEw","Ocean City 2013"))
	...
	for line in urllib2.urlopen(r'http://www.youtube.com/playlist?list=' + str(urlItem[0])).readlines():
		if '&amp;list=' + str(urlItem[0]) + '&amp;' in line and r'ux-thumb-wrap' not in line:
			try:
				...
				scoreString = scoreString + "<tr><td>" + vidTitle + "</td><td>" + vidStop + "</td><td>" + vidLikes + "</td><td>" + vidViews + "</td></tr>"
			except:
				pass
